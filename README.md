...
I only aim for solving part 1 of each day this year (silver star). If a day would also have a solution for part two (gold star), this will be present as a second `.sh` file.
